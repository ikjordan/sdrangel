...
This combo lets you set the TV standard type. This sets the number of lines per complete image, frame synchronization parameters and number of blank (black) lines. Choice is between:
  ...
  - **AllEvenI**: this is an experimental mode based on PAL625 that ignores the interlace field data, assuming each field is even. The display is updated every field. This allows the correct display of UHF output from 1980s computers which always output the same interlace field.
...
<table>
    ...
    <tr>
        <td>625</td>
        <td>PAL625, PAL525, ShortI, GuideI, AllEvenI, ShortNI,</td>
    </tr>
    <tr>
        <td>525</td>
